...
# RHIC
ydata_rhic = np.loadtxt('../calcs/photons/smash_calcs/rhic/SMASH-2.0.1/pT.txt', unpack = True)
...
v2data_rhic = np.loadtxt('../calcs/photons/smash_calcs/rhic/SMASH-2.0.1/SP_v2.txt', unpack = True)
...
# LHC
ydata_lhc = np.loadtxt('../calcs/photons/smash_calcs/lhc/SMASH-2.0.1/pT.txt', unpack = True)
...
v2data_lhc = np.loadtxt('../calcs/photons/smash_calcs/lhc/SMASH-2.0.1/SP_v2.txt', unpack = True)
...
plt.figtext(0.919, 0.894, "SMASH-2.0.1",color = "gray", fontsize = 5.3)
