...
// Size of the cells
const double CONST_cellsize_X=1.0; //In fm
const double CONST_cellsize_Y=1.0; //In fm
const double CONST_cellsize_Eta=1.0; //In units of rapidity
const double CONST_effective_dTau=1.0;
// Initial time tau_0
const double CONST_tau0=1.0;
