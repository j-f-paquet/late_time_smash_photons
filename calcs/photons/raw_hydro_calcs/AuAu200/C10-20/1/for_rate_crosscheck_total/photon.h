...
const bool CONST_with_shear_viscosity=false; //turn on and off shear viscosity
const bool CONST_with_bulk_viscosity=false; //turn on and off bulk viscosity
const bool CONST_with_viscosity=false; //general flag for viscosity


// Information about the spacetime grid, used only for the old evolution file format
//Number of cells of the grid
const int cellNb_x=1;
const int cellNb_y=1;
const int cellNb_eta=1;
// Size of the cells
const double CONST_cellsize_X=1; //In fm
const double CONST_cellsize_Y=1; //In fm
const double CONST_cellsize_Eta=1; //In units of rapidity
const double CONST_effective_dTau=1;
// Initial time tau_0
const double CONST_tau0=1;
...
const double CONST_freezeout_T=0.14;
