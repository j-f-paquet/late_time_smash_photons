...
//			break;
		...
		//rate pions bremstralung
		case hg_pion_brem_ideal_Rapp_fit_tabulated_normalized_to_smash:

			currRate->name="rate_hg_pion_brem_ideal_Rapp_fit_tabulated_normalized_to_smash";
			...
			currRate->max_kOverT=4.0;
                        ...
                        currRate->extra_normalisation_factor_function=smash_brem_norm;
...
double smash_brem_norm(double kOverT, double T, double kkPiOver_e_P_k2) {

        double a=0.15;

        return (1+a)*exp(-a*kOverT);
